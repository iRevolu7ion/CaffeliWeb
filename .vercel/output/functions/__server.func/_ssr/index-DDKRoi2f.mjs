...
const g4 = "/assets/gallery-4-DKSaTRB6.jpg";
...
function Nav({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 backdrop-blur-md bg-background/75 border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10 h-20 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "font-serif text-2xl tracking-tight text-forest-deep", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo.png", alt: "Caffeli Logo", className: "h-12 w-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest", children: "." })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl rounded-[2rem] bg-sand/70 p-6 sm:p-10 lg:p-16 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-up", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-wrap items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#gallery", className: "inline-flex items-center gap-2 rounded-full border border-forest/30 text-forest-deep px-7 py-3.5 text-sm hover:bg-cream transition-colors", children: "Ver catálogo" })
        ] })
      ] }),
...
function Gallery() {
  const imgs = [{
    src: g2,
    alt: "Rebanada de pastel con fresas",
    span: "row-span-2"
  }, {
    src: g1,
    alt: "Macarons pastel"
    ...
    src: g4,
    alt: "Pastel rústico con higos y miel",
    span: "row-span-2"
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "gallery", className: "px-4 sm:px-6 lg:px-10 pb-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-[0.25em] text-forest/80", children: "Galería" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.05] text-forest-deep", children: [
        "Pequeños ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic font-normal", children: "momentos" }),
        " de obrador."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 auto-rows-[180px] sm:auto-rows-[240px] gap-4", children: imgs.map((i, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-2xl overflow-hidden bg-sand ${i.span ?? ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: i.src, alt: i.alt, loading: "lazy", className: "w-full h-full object-cover hover:scale-105 transition-transform duration-[1200ms]" }) }, idx)) })
  ] }) });
}
